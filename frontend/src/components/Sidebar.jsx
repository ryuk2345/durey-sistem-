  ...
  <aside className="w-72 bg-surface border-r border-outline-variant h-screen flex flex-col fixed left-0 top-0 z-40">
    ...
    <div className="p-5 border-b border-outline-variant flex flex-col items-center gap-2 bg-surface text-on-surface">
      <img
        ...
        alt="Durey Logo"
        classsName="h-20 w-auto object-contain transition-all duration-200 dark:brightness-100 brightness-0"
      />
      ...
      {filteredItems.map(item => {
        ...
        return (
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-semibold rounded-lg transition-all duration-150 active:scale-95 ${isActive
    ...
    <div className="p-4 border-t border-outline-variant bg-surface-container-low flex flex-col gap-3">
      <div className="flex items-center justify-between bg-surface-container-high p-1 rounded-lg border border-outline-variant/30">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-md text-xs font-bold transition-all ${theme === 'light'
        ...
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-md text-xs font-bold transition-all ${theme === 'dark'
